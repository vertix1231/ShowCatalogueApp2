...
object DataDummy {
    fun generateDataMovieDummyResponse(): List<Movie> {
    ...
    fun generateDataTvShowDummyResponse(): List<Tvshow> {
    ...
    fun generateDataMovieDummy(): List<Showtaiment> {
        val listMovie = ArrayList<Showtaiment>()
    ...
    fun generateDataTvShowDummy(): List<Showtaiment> {
        val listTvShow = ArrayList<Showtaiment>()
